...
//
BLEByteCharacteristic Ramp01MinimumValue("5138f1ac-bf01-42fc-a321-09afd4de6e01", BLERead | BLEWrite);
...
AclStreamService.addCharacteristic(Ramp01MinimumValue);
AclStreamService.addCharacteristic(Ramp01MaximumValue);
